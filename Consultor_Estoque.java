package Produto_em_Estoque;

import Produto_em_Estoque.Entidade.Produto_Class;
import java.util.Locale;
import java.util.Scanner;

public class Consultor_Estoque {
  ...
  public static void main(String[] args) {
    ...
    System.out.println();
        ...
        Produto_Class produto = new Produto_Class(nameProduto, price, quantity);
